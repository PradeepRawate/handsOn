...
import com.osius.repository.UserRepository;
...
public class UserResource {
	...
	public User fetchUser(@PathVariable("userId") Integer userId) throws RestServiceException {
		try {
	...
	public List<User> getUsersByDepartment(@PathVariable("deptId") Integer deptId) throws RestServiceException {
		try {
